window.__ModuleLoader__.load({
	...
	factory: (require) => {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									...
									children: t(draft.provider === "custom" ? "customHint" : draft.provider === void 0 ? "automaticHint" : "configuredHint")
								})
							]
						}),
		...
		const zh = {
			...
			customHint: "自定义端点：填写 OpenAI 兼容的 API 地址、模型 ID 与 API Key（如小米 MiMo、Ollama、私有网关）。",
			apiKey: "API Key",
			keyConfigured: "已配置",
			keyMissing: "未配置",
			keyLoading: "检查中",
		...
		const en = {
			...
			customHint: "Custom endpoint: enter an OpenAI-compatible API base URL, model ID, and API key (e.g. MiMo, Ollama, or a private gateway).",
			apiKey: "API key",
